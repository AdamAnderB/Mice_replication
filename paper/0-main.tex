...
\documentclass[man, floatsintext, a4paper, 12pt, biblatex, donotrepeattitle]{apa7}
...
% Title
\title{Predictive Minds: Unlearning and Prediction Errors in Southern Min, Japanese, and Mandarin}
\shorttitle{Predicting Minds}

% Author
\author{University: Carnegie Mellon University}
\affiliation{Authors: Adam A. Bramlett}
...
\subfile{paper/1-abstract}
\subfile{paper/2-introduction}
\subfile{paper/3-methods}
\subfile{paper/4-results}
