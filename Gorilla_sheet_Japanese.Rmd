...
list.files("../extension_languages/japanese/selected_sounds/renamed_for_experiement")
path="../extension_languages/japanese/selected_sounds/renamed_for_experiement"
...
images<-sort(images)
images
high_frequency<-c("h_eeya","t_oori","sh_iiku")
low_frequency<-c("t_ori","sh_iku","h_eya")
image_1<-c("h_eeya","t_ori")
image_2<-c("t_oori","sh_iku")
image_3<-c("sh_iiku","h_eya")
```
...
```{r}
folder_path <- "../extension_languages/japanese/csv_folder"
