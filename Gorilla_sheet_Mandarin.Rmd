...
list.files("../extension_languages/mandarin/renamed_for_experiment/")
path="../extension_languages/mandarin/renamed_for_experiment/"
...
images<-sort(images)
images
high_frequency<-c("sh_ao","zh_ou","ch_ang")
low_frequency<-c("ji_ou","qi_ang","xi_ao")
image_1<-c("sh_ao","ji_ou")
image_2<-c("zh_ou","qi_ang")
image_3<-c("ch_ang","xi_ao")
```
...
```{r}
folder_path <- "../extension_languages/mandarin/csv_folder"
